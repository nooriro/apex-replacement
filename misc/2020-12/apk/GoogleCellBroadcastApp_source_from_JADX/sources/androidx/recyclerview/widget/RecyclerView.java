...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C02367.f7x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
            if (i != 2) {
    ...
    static /* synthetic */ class C02367 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f7x3d106619     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C02367.<clinit>():void");
        }
    }
