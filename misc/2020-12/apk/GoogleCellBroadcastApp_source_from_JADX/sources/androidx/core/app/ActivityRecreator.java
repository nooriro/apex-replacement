        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                ...
                if (needsRelaunchCall()) {
                    requestRelaunchActivityMethod.invoke(obj, new Object[]{obj2, null, null, 0, bool, null, null, bool, bool});
                } else {
                    activity.recreate();
                }
                mainHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        if (ActivityRecreator.performStopActivity3ParamsMethod != null) {
                            ActivityRecreator.performStopActivity3ParamsMethod.invoke(obj3, new Object[]{obj2, bool, "AppCompat recreation"});
                            return;
                        }
