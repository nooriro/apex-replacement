...
public final class ResourcesCompat {
    ...
    private static android.content.res.ColorStateList getCachedColorStateList(android.content.res.Resources r4, int r5) {
        /*
            java.lang.Object r0 = sColorStateCacheLock
            monitor-enter(r0)
            java.util.WeakHashMap<android.content.res.Resources, android.util.SparseArray<androidx.core.content.res.ResourcesCompat$ColorStateListCacheEntry>> r1 = sColorStateCaches     // Catch:{ all -> 0x0031 }
            java.lang.Object r1 = r1.get(r4)     // Catch:{ all -> 0x0031 }
            android.util.SparseArray r1 = (android.util.SparseArray) r1     // Catch:{ all -> 0x0031 }
            if (r1 == 0) goto L_0x002e
            int r2 = r1.size()     // Catch:{ all -> 0x0031 }
            if (r2 <= 0) goto L_0x002e
            java.lang.Object r2 = r1.get(r5)     // Catch:{ all -> 0x0031 }
            androidx.core.content.res.ResourcesCompat$ColorStateListCacheEntry r2 = (androidx.core.content.res.ResourcesCompat.ColorStateListCacheEntry) r2     // Catch:{ all -> 0x0031 }
            if (r2 == 0) goto L_0x002e
            android.content.res.Configuration r3 = r2.mConfiguration     // Catch:{ all -> 0x0031 }
            android.content.res.Configuration r4 = r4.getConfiguration()     // Catch:{ all -> 0x0031 }
            boolean r4 = r3.equals(r4)     // Catch:{ all -> 0x0031 }
            if (r4 == 0) goto L_0x002b
            android.content.res.ColorStateList r4 = r2.mValue     // Catch:{ all -> 0x0031 }
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.content.res.ResourcesCompat.getCachedColorStateList(android.content.res.Resources, int):android.content.res.ColorStateList");
    }

    private static void addColorStateListToCache(Resources resources, int i, ColorStateList colorStateList) {
        synchronized (sColorStateCacheLock) {
            SparseArray sparseArray = sColorStateCaches.get(resources);
            if (sparseArray == null) {
