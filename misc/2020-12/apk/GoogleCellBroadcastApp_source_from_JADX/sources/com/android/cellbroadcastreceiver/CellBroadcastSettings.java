...
public class CellBroadcastSettings extends Activity {
    ...
    public static void resetAllPreferences(Context context) {
        ...
        edit.remove("enable_cmas_extreme_threat_alerts").remove("enable_cmas_severe_threat_alerts").remove("enable_cmas_amber_alerts").remove("enable_public_safety_messages").remove("enable_emergency_alerts").remove("alert_reminder_interval").remove("override_dnd").remove("enable_area_update_info_alerts").remove("enable_test_alerts").remove("enable_state_local_test_alerts").remove("enable_alert_vibrate").remove("enable_cmas_presidential_alerts").remove("receive_cmas_in_second_language");
    ...
    public static class CellBroadcastSettingsFragment extends PreferenceFragment {
            ...
            if (getActivity().getPackageManager().hasSystemFeature("android.hardware.type.watch")) {
                ...
                this.mAlertReminder.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    public final boolean onPreferenceChange(Preference preference, Object obj) {
                        return CellBroadcastSettings.CellBroadcastSettingsFragment.this.mo5392xb5183b23(preference, obj);
                    }
                });
        ...
        public /* synthetic */ boolean mo5392xb5183b23(Preference preference, Object obj) {
            try {
        ...
        public void onCreatePreferences(Bundle bundle, String str) {
            ...
            if (!resourcesForDefaultSubId.getBoolean(R.bool.show_alert_speech_setting) && !packageManager.hasSystemFeature("android.hardware.type.watch") && (preferenceCategory = this.mAlertPreferencesCategory) != null && (twoStatePreference2 = this.mSpeechCheckBox) != null) {
            ...
            C02842 r4 = new Preference.OnPreferenceChangeListener() {
            ...
            TwoStatePreference twoStatePreference3 = this.mMasterToggle;
            if (twoStatePreference3 != null) {
                twoStatePreference3.setOnPreferenceChangeListener(r4);
            ...
            if (twoStatePreference4 != null) {
                twoStatePreference4.setOnPreferenceChangeListener(r4);
            }
            TwoStatePreference twoStatePreference5 = this.mExtremeCheckBox;
            if (twoStatePreference5 != null) {
                twoStatePreference5.setOnPreferenceChangeListener(r4);
            }
            TwoStatePreference twoStatePreference6 = this.mPublicSafetyMessagesChannelCheckBox;
            if (twoStatePreference6 != null) {
                twoStatePreference6.setOnPreferenceChangeListener(r4);
            }
            TwoStatePreference twoStatePreference7 = this.mEmergencyAlertsCheckBox;
            if (twoStatePreference7 != null) {
                twoStatePreference7.setOnPreferenceChangeListener(r4);
            }
            TwoStatePreference twoStatePreference8 = this.mSevereCheckBox;
            if (twoStatePreference8 != null) {
                twoStatePreference8.setOnPreferenceChangeListener(r4);
            ...
            TwoStatePreference twoStatePreference9 = this.mAmberCheckBox;
            if (twoStatePreference9 != null) {
                twoStatePreference9.setOnPreferenceChangeListener(r4);
            }
            TwoStatePreference twoStatePreference10 = this.mTestCheckBox;
            if (twoStatePreference10 != null) {
                twoStatePreference10.setOnPreferenceChangeListener(r4);
            }
            TwoStatePreference twoStatePreference11 = this.mStateLocalTestCheckBox;
            if (twoStatePreference11 != null) {
                twoStatePreference11.setOnPreferenceChangeListener(r4);
            }
            ...
            if (this.mOverrideDndCheckBox != null) {
                ...
                this.mOverrideDndCheckBox.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener(defaultSharedPreferences) {
                    ...
                    public final boolean onPreferenceChange(Preference preference, Object obj) {
                        return CellBroadcastSettings.CellBroadcastSettingsFragment.this.mo5393x5e9addd9(this.f$1, preference, obj);
                    }
                });
            }
            ...
            if (preference != null) {
                preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    public final boolean onPreferenceClick(Preference preference) {
                        return CellBroadcastSettings.CellBroadcastSettingsFragment.this.mo5394xebd58f5a(preference);
                    }
                });
            }
        ...
        public /* synthetic */ boolean mo5393x5e9addd9(SharedPreferences sharedPreferences, Preference preference, Object obj) {
        ...
        public /* synthetic */ boolean mo5394xebd58f5a(Preference preference) {
        ...
        public void updatePreferenceVisibility() {
            ...
            if (twoStatePreference != null) {
                twoStatePreference.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.show_presidential_alerts_settings));
            }
            TwoStatePreference twoStatePreference2 = this.mExtremeCheckBox;
            boolean z = false;
            if (twoStatePreference2 != null) {
                twoStatePreference2.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.show_extreme_alert_settings) && !cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.cmas_alert_extreme_channels_range_strings).isEmpty());
            }
            TwoStatePreference twoStatePreference3 = this.mSevereCheckBox;
            if (twoStatePreference3 != null) {
                twoStatePreference3.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.show_severe_alert_settings) && !cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.cmas_alerts_severe_range_strings).isEmpty());
            }
            TwoStatePreference twoStatePreference4 = this.mAmberCheckBox;
            if (twoStatePreference4 != null) {
                twoStatePreference4.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.show_amber_alert_settings) && !cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.cmas_amber_alerts_channels_range_strings).isEmpty());
            }
            TwoStatePreference twoStatePreference5 = this.mPublicSafetyMessagesChannelCheckBox;
            if (twoStatePreference5 != null) {
                twoStatePreference5.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.show_public_safety_settings) && !cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.public_safety_messages_channels_range_strings).isEmpty());
            }
            ...
            if (twoStatePreference8 != null) {
                twoStatePreference8.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.show_state_local_test_settings) && !cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.state_local_test_alert_range_strings).isEmpty());
            }
            TwoStatePreference twoStatePreference9 = this.mReceiveCmasInSecondLanguageCheckBox;
            if (twoStatePreference9 != null) {
                twoStatePreference9.setVisible(!resourcesForDefaultSubId.getString(R.string.emergency_alert_second_language_code).isEmpty());
            }
            TwoStatePreference twoStatePreference10 = this.mAreaUpdateInfoCheckBox;
            if (twoStatePreference10 != null) {
                twoStatePreference10.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.config_showAreaUpdateInfoSettings));
            }
            TwoStatePreference twoStatePreference11 = this.mOverrideDndCheckBox;
            if (twoStatePreference11 != null) {
                twoStatePreference11.setVisible(resourcesForDefaultSubId.getBoolean(R.bool.show_override_dnd_settings));
            }
            TwoStatePreference twoStatePreference12 = this.mEnableVibrateCheckBox;
            if (twoStatePreference12 != null) {
                if (resourcesForDefaultSubId.getBoolean(R.bool.show_override_dnd_settings) || !resourcesForDefaultSubId.getBoolean(R.bool.override_dnd_default)) {
                    z = true;
                }
