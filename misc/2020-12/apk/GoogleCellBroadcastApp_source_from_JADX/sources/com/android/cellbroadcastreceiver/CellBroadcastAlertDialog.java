...
public class CellBroadcastAlertDialog extends Activity {
    ...
    private class ScreenOffHandler extends Handler {
        ...
        public void startScreenOnTimer() {
            ...
            sendEmptyMessageDelayed(incrementAndGet, 60000);
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!CellBroadcastSettings.getResourcesForDefaultSubId(getApplicationContext()).getBoolean(R.bool.mute_by_physical_button)) {
    ...
    private void updateAlertText(SmsCbMessage smsCbMessage) {
        ...
        String overrideTranslation = overrideTranslation(dialogTitleResource, resources, smsCbMessage.getLanguageCode());
        ...
        if (parcelableArrayListExtra != null) {
            if (intent.getBooleanExtra("from_save_state_notification", false)) {
                ...
                if (CellBroadcastSettings.getResourcesForDefaultSubId(getApplicationContext()).getBoolean(R.bool.show_cmas_messages_in_priority_order)) {
                    Collections.sort(this.mMessageList, $$Lambda$CellBroadcastAlertDialog$dYhgtzVOBVdCPUMA3YDeZ1iM2I.INSTANCE);
                }
            }
    ...
    static /* synthetic */ int lambda$onNewIntent$4(Object obj, Object obj2) {
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        ...
        if (CellBroadcastSettings.getResources(getApplicationContext(), getLatestMessage().getSubscriptionId()).getBoolean(R.bool.mute_by_physical_button)) {
