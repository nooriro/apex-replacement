...
public class CellBroadcastHandler extends WakeLockStateMachine {
    ...
    public interface LocationUpdateCallback {
        void onLocationUpdate(CbGeoUtils.LatLng latLng);
    }
    ...
    public CellBroadcastHandler(String str, Context context, Looper looper) {
        ...
        if (smsCbMessage.needGeoFencingCheck()) {
            ...
            requestLocationUpdate(new LocationUpdateCallback(smsCbMessage, insert, slotIndex) {
                ...
                public final void onLocationUpdate(CbGeoUtils.LatLng latLng) {
                    CellBroadcastHandler.this.lambda$handleBroadcastSms$2$CellBroadcastHandler(this.f$1, this.f$2, this.f$3, latLng);
                }
    ...
    public /* synthetic */ void lambda$handleBroadcastSms$2$CellBroadcastHandler(SmsCbMessage smsCbMessage, Uri uri, int i, CbGeoUtils.LatLng latLng) {
        if (latLng == null) {
            broadcastMessage(smsCbMessage, uri, i);
            return;
        }
        performGeoFencing(smsCbMessage, uri, smsCbMessage.getGeometries(), latLng, i);
    }
    ...
    public void performGeoFencing(SmsCbMessage smsCbMessage, Uri uri, List<CbGeoUtils.Geometry> list, CbGeoUtils.LatLng latLng, int i) {
        if (WakeLockStateMachine.DBG) {
        ...
        for (CbGeoUtils.Geometry contains : list) {
    ...
    private static final class LocationRequester {
        ...
        public void requestLocationUpdate(LocationUpdateCallback locationUpdateCallback, int i) {
            this.mLocationHandler.post(new Runnable(locationUpdateCallback, i) {
                ...
                public final void run() {
                    CellBroadcastHandler.LocationRequester.this.mo35x35c69096(this.f$1, this.f$2);
                }
            });
        }
        ...
        public void onLocationUpdate(Location location) {
            ...
            for (LocationUpdateCallback onLocationUpdate : this.mCallbacks) {
                onLocationUpdate.onLocationUpdate(latLng);
            }
            ...
            if (hasPermission("android.permission.ACCESS_FINE_LOCATION") || hasPermission("android.permission.ACCESS_COARSE_LOCATION")) {
                if (!this.mLocationUpdateInProgress) {
                    ...
                    try {
                        ...
                        locationUpdateCallback.onLocationUpdate((CbGeoUtils.LatLng) null);
                        return;
                    }
                }
