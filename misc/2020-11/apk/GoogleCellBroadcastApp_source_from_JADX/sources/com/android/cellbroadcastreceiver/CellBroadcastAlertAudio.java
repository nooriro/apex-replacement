...
public class CellBroadcastAlertAudio extends Service implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener, AudioManager.OnAudioFocusChangeListener {
                ...
                switch (message.what) {
                    ...
                    case 1001:
                        ...
                        if (CellBroadcastAlertAudio.this.mMessageBody != null && CellBroadcastAlertAudio.this.mTtsEngineReady && CellBroadcastAlertAudio.this.mTtsLanguageSupported) {
                            ...
                            TextToSpeech access$900 = CellBroadcastAlertAudio.this.mTts;
                            CellBroadcastAlertAudio cellBroadcastAlertAudio = CellBroadcastAlertAudio.this;
                            access$900.setAudioAttributes(cellBroadcastAlertAudio.getAlertAudioAttributes(cellBroadcastAlertAudio.mAlertType));
    ...
    public AudioAttributes getAlertAudioAttributes(CellBroadcastAlertService.AlertType alertType) {
        ...
        if (alertType == CellBroadcastAlertService.AlertType.INFO) {
            i = 5;
        }
        builder.setUsage(i);
        if (this.mOverrideDnd) {
