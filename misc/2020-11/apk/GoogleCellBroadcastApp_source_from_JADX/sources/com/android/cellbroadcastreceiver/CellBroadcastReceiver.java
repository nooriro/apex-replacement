...
public class CellBroadcastReceiver extends BroadcastReceiver {
    ...
    public Resources getResourcesMethod() {
        return CellBroadcastSettings.getResources(this.mContext, Integer.MAX_VALUE);
    }
    ...
    static void startConfigService(Context context) {
        if (isSystemUser(context)) {
            Intent intent = new Intent(CellBroadcastConfigService.ACTION_ENABLE_CHANNELS, (Uri) null, context, CellBroadcastConfigService.class);
