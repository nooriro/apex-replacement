...
public class CellBroadcastAlertAudio extends Service implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public void onCreate() {
        ...
        C02822 r0 = new PhoneStateListener() {
    ...
    private void playAlertTone(CellBroadcastAlertService.AlertType alertType, int[] iArr) {
        ...
        if (this.mEnableVibrate) {
            ...
            if (!resources.getBoolean(R.bool.mute_by_physical_button)) {
                ScreenOffReceiver screenOffReceiver = new ScreenOffReceiver(createWaveform, build);
        ...
        if (this.mEnableAudio) {
            ...
            try {
                ...
                switch (C02855.f13x97d16d5c[alertType.ordinal()]) {
                    case 1:
                ...
                if (alertType == CellBroadcastAlertService.AlertType.INFO || alertType == CellBroadcastAlertService.AlertType.AREA) {
                    i2 = 5;
                }
                audioManager.requestAudioFocus(this, builder2.setLegacyStreamType(i2).build(), 2, 1);
    ...
    static /* synthetic */ class C02855 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f13x97d16d5c     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f13x97d16d5c     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f13x97d16d5c     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f13x97d16d5c     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f13x97d16d5c     // Catch:{ NoSuchFieldError -> 0x0049 }
                com.android.cellbroadcastreceiver.CellBroadcastAlertService$AlertType r1 = com.android.cellbroadcastreceiver.CellBroadcastAlertService.AlertType.AREA     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = f13x97d16d5c     // Catch:{ NoSuchFieldError -> 0x0054 }
                com.android.cellbroadcastreceiver.CellBroadcastAlertService$AlertType r1 = com.android.cellbroadcastreceiver.CellBroadcastAlertService.AlertType.TEST     // Catch:{ NoSuchFieldError -> 0x0054 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0054 }
                r2 = 7
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0054 }
            L_0x0054:
                int[] r0 = f13x97d16d5c     // Catch:{ NoSuchFieldError -> 0x0060 }
                com.android.cellbroadcastreceiver.CellBroadcastAlertService$AlertType r1 = com.android.cellbroadcastreceiver.CellBroadcastAlertService.AlertType.DEFAULT     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.cellbroadcastreceiver.CellBroadcastAlertAudio.C02855.<clinit>():void");
        }
    }
    ...
    public AudioAttributes getAlertAudioAttributes() {
        ...
        CellBroadcastAlertService.AlertType alertType = this.mAlertType;
        if (alertType == CellBroadcastAlertService.AlertType.INFO || alertType == CellBroadcastAlertService.AlertType.AREA) {
            i = 5;
        }
        builder.setUsage(i);
    ...
    private class ScreenOffReceiver extends BroadcastReceiver {
        ...
        public ScreenOffReceiver(VibrationEffect vibrationEffect, AudioAttributes audioAttributes) {
            this.mVibrationEffect = vibrationEffect;
            this.mAudioAttr = audioAttributes;
        }

        public void onReceive(Context context, Intent intent) {
            if (CellBroadcastAlertAudio.this.mState == 1) {
                CellBroadcastAlertAudio.this.mVibrator.vibrate(this.mVibrationEffect, this.mAudioAttr);
            }
        }
    }
