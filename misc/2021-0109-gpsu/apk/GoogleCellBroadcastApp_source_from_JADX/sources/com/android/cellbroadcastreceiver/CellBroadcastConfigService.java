...
public class CellBroadcastConfigService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        } else if ("UPDATE_SETTINGS_FOR_CARRIER".equals(intent.getAction())) {
            Log.e("CellBroadcastConfigService", "Reset all preferences");
    ...
    public void enableCellBroadcastChannels(int i) {
        ...
        boolean z6 = z && resources.getBoolean(R.bool.show_separate_exercise_settings) && defaultSharedPreferences.getBoolean("enable_exercise_alerts", false);
        boolean z7 = resources.getBoolean(R.bool.config_showAreaUpdateInfoSettings) && defaultSharedPreferences.getBoolean("enable_area_update_info_alerts", false);
        boolean z8 = z && defaultSharedPreferences.getBoolean("enable_public_safety_messages", true);
        boolean z9 = z && defaultSharedPreferences.getBoolean("enable_state_local_test_alerts", false);
        boolean z10 = z && defaultSharedPreferences.getBoolean("enable_emergency_alerts", true);
        ...
        setCellBroadcastRange(i, z5 || z6, cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.exercise_alert_range_strings));
        ...
        setCellBroadcastRange(i, z8, cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.public_safety_messages_channels_range_strings));
        setCellBroadcastRange(i, z9, cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.state_local_test_alert_range_strings));
        ...
        setCellBroadcastRange(i, z10, cellBroadcastChannelManager.getCellBroadcastChannelRanges(R.array.emergency_alerts_channels_range_strings));
        ...
        while (it.hasNext()) {
            ...
            int i2 = C02871.f14x97d16d5c[next.mAlertType.ordinal()];
            setCellBroadcastRange(i, i2 != 1 ? i2 != 2 ? z : z5 : z7, new ArrayList(Arrays.asList(new CellBroadcastChannelManager.CellBroadcastChannelRange[]{next})));
        }
    }
    ...
    static /* synthetic */ class C02871 {
        ...
        static final /* synthetic */ int[] f14x97d16d5c;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14x97d16d5c     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.cellbroadcastreceiver.CellBroadcastConfigService.C02871.<clinit>():void");
        }
    }
    ...
    private void setCellBroadcastRange(int i, boolean z, List<CellBroadcastChannelManager.CellBroadcastChannelRange> list) {
        ...
        if (list != null) {
            for (CellBroadcastChannelManager.CellBroadcastChannelRange next : list) {
                if (next.mAlwaysOn) {
                    log("mAlwaysOn is set to true, enable the range: " + next.mStartId + ":" + next.mEndId);
                    z = true;
                }
                if (z) {
