...
public class CellBroadcastListActivity extends Activity {
    ...
    public static class CursorLoaderListFragment extends ListFragment implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
            ...
            if (((UserManager) getContext().getSystemService(UserManager.class)).isAdminUser()) {
                menu.add(0, 6, 0, R.string.menu_preferences).setIcon(17301577);
            }
        }
        ...
        public boolean onOptionsItemSelected(MenuItem menuItem) {
            ...
            if (itemId == 3) {
                ...
                startActivity(new Intent(getActivity(), CellBroadcastSettings.class));
                return false;
            }
        }
        ...
        public static class DeleteDialogFragment extends DialogFragment {
            public Dialog onCreateDialog(Bundle bundle) {
                ...
                long j = getArguments().getLong("row_id");
                boolean z = j == -1;
                DeleteThreadListener deleteThreadListener = new DeleteThreadListener(getActivity(), j);
                AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
                builder.setIconAttribute(16843605).setCancelable(true).setPositiveButton(R.string.button_delete, deleteThreadListener).setNegativeButton(R.string.button_cancel, (DialogInterface.OnClickListener) null).setMessage(z ? R.string.confirm_delete_all_broadcasts : R.string.confirm_delete_broadcast);
        ...
        public static class DeleteThreadListener implements DialogInterface.OnClickListener {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                new CellBroadcastContentProvider.AsyncCellBroadcastTask(this.mContext.getContentResolver()).execute(new CellBroadcastContentProvider.CellBroadcastOperation[]{
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0016: INVOKE  
                      (wrap: com.android.cellbroadcastreceiver.CellBroadcastContentProvider$AsyncCellBroadcastTask : 0x0008: CONSTRUCTOR  (r4v1 com.android.cellbroadcastreceiver.CellBroadcastContentProvider$AsyncCellBroadcastTask) = 
                      (wrap: android.content.ContentResolver : 0x0004: INVOKE  (r0v1 android.content.ContentResolver) = 
                      (wrap: android.content.Context : 0x0002: IGET  (r0v0 android.content.Context) = 
                     ...
                     com.android.cellbroadcastreceiver.CellBroadcastListActivity.CursorLoaderListFragment.DeleteThreadListener.mContext android.content.Context)
                     android.content.Context.getContentResolver():android.content.ContentResolver type: VIRTUAL)
                     call: com.android.cellbroadcastreceiver.CellBroadcastContentProvider.AsyncCellBroadcastTask.<init>(android.content.ContentResolver):void type: CONSTRUCTOR)
                      (wrap: com.android.cellbroadcastreceiver.CellBroadcastContentProvider$CellBroadcastOperation[] : ?: FILLED_NEW_ARRAY  (r0v3 com.android.cellbroadcastreceiver.CellBroadcastContentProvider$CellBroadcastOperation[]) = 
                      (wrap: com.android.cellbroadcastreceiver.-$$Lambda$CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener$TAg4p0SDbYyyZ_lTPcQfnMjLQpw : 0x0010: CONSTRUCTOR  (r1v0 com.android.cellbroadcastreceiver.-$$Lambda$CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener$TAg4p0SDbYyyZ_lTPcQfnMjLQpw) = 
                      (r2v0 'this' com.android.cellbroadcastreceiver.CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener A[THIS])
                    ...
                    Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: ?: FILLED_NEW_ARRAY  (r0v3 com.android.cellbroadcastreceiver.CellBroadcastContentProvider$CellBroadcastOperation[]) = 
                      (wrap: com.android.cellbroadcastreceiver.-$$Lambda$CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener$TAg4p0SDbYyyZ_lTPcQfnMjLQpw : 0x0010: CONSTRUCTOR  (r1v0 com.android.cellbroadcastreceiver.-$$Lambda$CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener$TAg4p0SDbYyyZ_lTPcQfnMjLQpw) = 
                      (r2v0 'this' com.android.cellbroadcastreceiver.CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener A[THIS])
                     call: com.android.cellbroadcastreceiver.-$$Lambda$CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener$TAg4p0SDbYyyZ_lTPcQfnMjLQpw.<init>(com.android.cellbroadcastreceiver.CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener):void type: CONSTRUCTOR)
                     elemType: com.android.cellbroadcastreceiver.CellBroadcastContentProvider$CellBroadcastOperation in method: com.android.cellbroadcastreceiver.CellBroadcastListActivity.CursorLoaderListFragment.DeleteThreadListener.onClick(android.content.DialogInterface, int):void, dex: classes.dex
                    	...
                    	... 59 more
                    Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0010: CONSTRUCTOR  (r1v0 com.android.cellbroadcastreceiver.-$$Lambda$CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener$TAg4p0SDbYyyZ_lTPcQfnMjLQpw) = 
                      (r2v0 'this' com.android.cellbroadcastreceiver.CellBroadcastListActivity$CursorLoaderListFragment$DeleteThreadListener A[THIS])
            ...
            public /* synthetic */ boolean mo5403xfa4f2552(CellBroadcastContentProvider cellBroadcastContentProvider) {
                long j = this.mRowId;
                if (j != -1) {
