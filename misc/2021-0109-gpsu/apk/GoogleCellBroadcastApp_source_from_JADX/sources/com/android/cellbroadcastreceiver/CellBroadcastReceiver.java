...
public class CellBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("com.android.cellbroadcastreceiver.intent.action.MARK_AS_READ".equals(action)) {
            EventLog.writeEvent(1397638484, new Object[]{"162741784", -1, null});
            ...
            if (!intent.getBooleanExtra("android.telephony.extra.REBROADCAST_ON_UNLOCK", false)) {
                ...
                boolean z = getDefaultSharedPreferences().getBoolean("legacy_data_migration", false);
            ...
            if (SystemProperties.getInt("ro.debuggable", 0) == 1 || resourcesMethod.getBoolean(R.bool.allow_testing_mode_on_user_build)) {
            ...
            new CellBroadcastContentProvider.AsyncCellBroadcastTask(this.mContext.getContentResolver()).execute(new CellBroadcastContentProvider.CellBroadcastOperation[]{new CellBroadcastContentProvider.CellBroadcastOperation() {
                public final boolean execute(CellBroadcastContentProvider cellBroadcastContentProvider) {
                    return CellBroadcastReceiver.this.lambda$onReceive$1$CellBroadcastReceiver(cellBroadcastContentProvider);
                }
            }});
        } else {
    ...
    public /* synthetic */ boolean lambda$onReceive$1$CellBroadcastReceiver(CellBroadcastContentProvider cellBroadcastContentProvider) {
        cellBroadcastContentProvider.resyncToSmsInbox(this.mContext);
        return true;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x00f7, code lost:
        throw r14;
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [B:6:0x0030, B:17:0x004d] */
    ...
    public void migrateSharedPreferenceFromLegacy() {
        /*
            ...
            java.lang.String r13 = "alert_reminder_interval"
            java.lang.String[] r1 = new java.lang.String[]{r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13}
            android.content.Context r2 = r14.mContext     // Catch:{ Exception -> 0x00f8 }
            android.content.ContentResolver r2 = r2.getContentResolver()     // Catch:{ Exception -> 0x00f8 }
            android.content.ContentProviderClient r2 = r2.acquireContentProviderClient(r0)     // Catch:{ Exception -> 0x00f8 }
            java.lang.String r3 = "CellBroadcastReceiver"
            if (r2 != 0) goto L_0x0039
            java.lang.String r14 = "No legacy provider available for sharedpreference migration"
            android.util.Log.d(r3, r14)     // Catch:{ all -> 0x00ec }
            if (r2 == 0) goto L_0x0038
            r2.close()     // Catch:{ Exception -> 0x00f8 }
        L_0x0038:
            return
        L_0x0039:
            android.content.Context r14 = r14.mContext     // Catch:{ all -> 0x00ec }
            android.content.SharedPreferences r14 = android.preference.PreferenceManager.getDefaultSharedPreferences(r14)     // Catch:{ all -> 0x00ec }
            android.content.SharedPreferences$Editor r14 = r14.edit()     // Catch:{ all -> 0x00ec }
            r4 = 0
        L_0x0044:
            r5 = 13
            if (r4 >= r5) goto L_0x00e3
            r5 = r1[r4]     // Catch:{ all -> 0x00ec }
            java.lang.String r6 = "get_preference"
            r7 = 0
            android.os.Bundle r6 = r2.call(r0, r6, r5, r7)     // Catch:{ RemoteException -> 0x00ca }
            if (r6 == 0) goto L_0x00b5
            boolean r7 = r6.containsKey(r5)     // Catch:{ RemoteException -> 0x00ca }
            if (r7 == 0) goto L_0x00b5
            java.lang.Object r7 = r6.get(r5)     // Catch:{ RemoteException -> 0x00ca }
            if (r7 != 0) goto L_0x0061
            goto L_0x00df
        L_0x0061:
            boolean r8 = r7 instanceof java.lang.Boolean     // Catch:{ RemoteException -> 0x00ca }
            java.lang.String r9 = "val: "
            java.lang.String r10 = "migrateSharedPreferenceFromLegacy: "
            if (r8 == 0) goto L_0x008d
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ RemoteException -> 0x00ca }
            r7.<init>()     // Catch:{ RemoteException -> 0x00ca }
            r7.append(r10)     // Catch:{ RemoteException -> 0x00ca }
            r7.append(r5)     // Catch:{ RemoteException -> 0x00ca }
            r7.append(r9)     // Catch:{ RemoteException -> 0x00ca }
            boolean r8 = r6.getBoolean(r5)     // Catch:{ RemoteException -> 0x00ca }
            r7.append(r8)     // Catch:{ RemoteException -> 0x00ca }
            java.lang.String r7 = r7.toString()     // Catch:{ RemoteException -> 0x00ca }
            android.util.Log.d(r3, r7)     // Catch:{ RemoteException -> 0x00ca }
            boolean r6 = r6.getBoolean(r5)     // Catch:{ RemoteException -> 0x00ca }
            r14.putBoolean(r5, r6)     // Catch:{ RemoteException -> 0x00ca }
            goto L_0x00df
        L_0x008d:
            boolean r7 = r7 instanceof java.lang.String     // Catch:{ RemoteException -> 0x00ca }
            ...
            r7.append(r5)     // Catch:{ RemoteException -> 0x00ca }
            r7.append(r9)     // Catch:{ RemoteException -> 0x00ca }
            java.lang.String r8 = r6.getString(r5)     // Catch:{ RemoteException -> 0x00ca }
            r7.append(r8)     // Catch:{ RemoteException -> 0x00ca }
            java.lang.String r7 = r7.toString()     // Catch:{ RemoteException -> 0x00ca }
            android.util.Log.d(r3, r7)     // Catch:{ RemoteException -> 0x00ca }
            java.lang.String r6 = r6.getString(r5)     // Catch:{ RemoteException -> 0x00ca }
            r14.putString(r5, r6)     // Catch:{ RemoteException -> 0x00ca }
            goto L_0x00df
        L_0x00b5:
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ RemoteException -> 0x00ca }
            r6.<init>()     // Catch:{ RemoteException -> 0x00ca }
            java.lang.String r7 = "migrateSharedPreferenceFromLegacy: unsupported key: "
            r6.append(r7)     // Catch:{ RemoteException -> 0x00ca }
            r6.append(r5)     // Catch:{ RemoteException -> 0x00ca }
            java.lang.String r5 = r6.toString()     // Catch:{ RemoteException -> 0x00ca }
            android.util.Log.d(r3, r5)     // Catch:{ RemoteException -> 0x00ca }
            goto L_0x00df
        L_0x00ca:
            r5 = move-exception
            ...
            java.lang.String r5 = r6.toString()     // Catch:{ all -> 0x00ec }
            android.util.Log.e(r3, r5)     // Catch:{ all -> 0x00ec }
        L_0x00df:
            int r4 = r4 + 1
            goto L_0x0044
        L_0x00e3:
            r14.apply()     // Catch:{ all -> 0x00ec }
        ...
        L_0x00f3:
            r0 = move-exception
            r14.addSuppressed(r0)     // Catch:{ Exception -> 0x00f8 }
        L_0x00f7:
            throw r14     // Catch:{ Exception -> 0x00f8 }
        L_0x00f8:
            r14 = move-exception
