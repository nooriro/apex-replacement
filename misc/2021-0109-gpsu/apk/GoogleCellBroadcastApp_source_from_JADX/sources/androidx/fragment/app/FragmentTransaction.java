...
public abstract class FragmentTransaction {
    ...
    int mExitAnim;
    String mName;
    ArrayList<C0177Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0177Op {
        ...
        C0177Op(int i, Fragment fragment) {
            this.mCmd = i;
    ...
    public void doAddOp(int i, Fragment fragment, String str, int i2) {
        ...
        addOp(new C0177Op(i2, fragment));
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0177Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0177Op(7, fragment));
        return this;
    }
