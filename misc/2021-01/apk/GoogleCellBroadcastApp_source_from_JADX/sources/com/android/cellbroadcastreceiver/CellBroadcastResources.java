...
public class CellBroadcastResources {
            ...
            if (cellBroadcastChannelRanges != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (serviceCategory >= next.mStartId && serviceCategory <= next.mEndId) {
                        switch (C02821.f13x97d16d5c[next.mAlertType.ordinal()]) {
                            case 1:
                                break;
                            case 2:
                                return R.string.etws_earthquake_warning;
    ...
    static /* synthetic */ class C02821 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.cellbroadcastreceiver.CellBroadcastResources.C02821.<clinit>():void");
        }
    }
    ...
    static int getDialogPictogramResource(android.content.Context r6, android.telephony.SmsCbMessage r7) {
        ...
        L_0x0039:
            ...
            int r5 = r4.mEndId
            if (r0 > r5) goto L_0x0039
            int[] r5 = com.android.cellbroadcastreceiver.CellBroadcastResources.C02821.f13x97d16d5c
