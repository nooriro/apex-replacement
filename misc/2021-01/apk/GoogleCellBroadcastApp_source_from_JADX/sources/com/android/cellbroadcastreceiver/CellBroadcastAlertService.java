...
public class CellBroadcastAlertService extends Service {
    ...
    private void writeMessageToSmsInbox(SmsCbMessage smsCbMessage) {
        ...
        contentValues.put("address", context2.getString(CellBroadcastResources.getSmsSenderAddressResource(context2, smsCbMessage)));
        Context context3 = this.mContext;
        contentValues.put("thread_id", Long.valueOf(Telephony.Threads.getOrCreateThreadId(context3, context3.getString(CellBroadcastResources.getSmsSenderAddressResource(context3, smsCbMessage)))));
