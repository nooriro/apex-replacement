...
class FragmentStateManager {
    ...
    public int computeExpectedState() {
        ...
        L_0x0032:
            ...
            androidx.fragment.app.SpecialEffectsController$Operation$Type r0 = r0.getAwaitingCompletionType(r9)
        L_0x0049:
            androidx.fragment.app.SpecialEffectsController$Operation$Type r2 = androidx.fragment.app.SpecialEffectsController.Operation.Type.ADD
            r6 = -1
            r7 = 3
            ...
            goto L_0x0073
        L_0x0055:
            androidx.fragment.app.SpecialEffectsController$Operation$Type r2 = androidx.fragment.app.SpecialEffectsController.Operation.Type.REMOVE
        ...
        L_0x0082:
            int[] r0 = androidx.fragment.app.FragmentStateManager.C01692.$SwitchMap$androidx$lifecycle$Lifecycle$State
    ...
    static /* synthetic */ class C01692 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C01692.<clinit>():void");
        }
    }
                    ...
                    if (computeExpectedState != this.mFragment.mState) {
                            ...
                            switch (i2) {
                                ...
                                case 4:
                                    if (!(this.mFragment.mView == null || this.mFragment.mContainer == null)) {
                                        ...
                                        orCreateController2.enqueueAdd(this, cancellationSignal2);
                                    }
                        ...
                        if (FragmentManager.USE_STATE_MANAGER && this.mFragment.mHiddenChanged) {
                            if (!(this.mFragment.mView == null || this.mFragment.mContainer == null)) {
                                ...
                                this.mHiddenAnimationCancellationSignal = cancellationSignal3;
                                if (this.mFragment.mHidden) {
                                    orCreateController3.enqueueHide(this, cancellationSignal3);
                                } else {
                                    orCreateController3.enqueueShow(this, cancellationSignal3);
                                }
                            }
