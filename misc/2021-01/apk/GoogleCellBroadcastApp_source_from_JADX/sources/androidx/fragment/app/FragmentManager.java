...
public abstract class FragmentManager {
    ...
    /* access modifiers changed from: private */
    public final ConcurrentHashMap<String, Object> mResultListeners = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */
    public final ConcurrentHashMap<String, Bundle> mResults = new ConcurrentHashMap<>();
    ...
    class C01606 implements LifecycleEventObserver {
    ...
    public void moveToState(androidx.fragment.app.Fragment r11, int r12) {
        ...
        L_0x0028:
            ...
            java.util.concurrent.ConcurrentHashMap<androidx.fragment.app.Fragment, java.util.HashSet<androidx.core.os.CancellationSignal>> r2 = r10.mExitAnimationCancellationSignals
        ...
        L_0x0097:
            ...
            boolean r2 = isLoggingEnabled(r5)
        ...
        L_0x00c6:
            ...
            android.view.View r3 = r11.mView
            r3.clearAnimation()
            boolean r3 = r11.isRemovingParent()
            if (r3 != 0) goto L_0x0116
            int r3 = r10.mCurState
            r7 = 0
            if (r3 <= r6) goto L_0x0101
            boolean r3 = r10.mDestroyed
            if (r3 != 0) goto L_0x0101
            android.view.View r3 = r11.mView
            int r3 = r3.getVisibility()
            if (r3 != 0) goto L_0x0101
            float r3 = r11.mPostponedAlpha
            int r3 = (r3 > r7 ? 1 : (r3 == r7 ? 0 : -1))
            if (r3 < 0) goto L_0x0101
            androidx.fragment.app.FragmentHostCallback<?> r2 = r10.mHost
            android.content.Context r2 = r2.getContext()
            r3 = 0
            androidx.fragment.app.FragmentAnim$AnimationOrAnimator r2 = androidx.fragment.app.FragmentAnim.loadAnimation(r2, r11, r3)
        L_0x0101:
            r11.mPostponedAlpha = r7
            android.view.ViewGroup r3 = r11.mContainer
            android.view.View r6 = r11.mView
            if (r2 == 0) goto L_0x010e
            androidx.fragment.app.FragmentTransition$Callback r7 = r10.mFragmentTransitionCallback
            androidx.fragment.app.FragmentAnim.animateRemoveFragment(r11, r2, r7)
        L_0x010e:
            r3.removeView(r6)
        ...
        L_0x0121:
            ...
            java.util.concurrent.ConcurrentHashMap<androidx.fragment.app.Fragment, java.util.HashSet<androidx.core.os.CancellationSignal>> r10 = r10.mExitAnimationCancellationSignals
        ...
        L_0x0136:
            int r10 = r11.mState
            if (r10 == r12) goto L_0x0168
            boolean r10 = isLoggingEnabled(r5)
    ...
    private void executeOpsTogether(java.util.ArrayList<androidx.fragment.app.BackStackRecord> r18, java.util.ArrayList<java.lang.Boolean> r19, int r20, int r21) {
        ...
        L_0x0083:
            ...
            androidx.fragment.app.FragmentTransaction$Op r7 = (androidx.fragment.app.FragmentTransaction.C0171Op) r7
        ...
        L_0x00ba:
            ...
            int r0 = r6.mCurState
            r6.moveToState((int) r0, (boolean) r1)
        L_0x00c8:
            int r0 = r3 + -1
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0171Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
    ...
    private void endAnimatingAwayFragments() {
        if (USE_STATE_MANAGER) {
            for (SpecialEffectsController cancelAllOperations : collectAllSpecialEffectsController()) {
    ...
    private void dispatchStateChange(int i) {
        try {
            ...
            moveToState(i, false);
            if (USE_STATE_MANAGER) {
                for (SpecialEffectsController executePendingOperations : collectAllSpecialEffectsController()) {
                    executePendingOperations.executePendingOperations();
                }
            }
            this.mExecutingActions = false;
            execPendingActions(true);
