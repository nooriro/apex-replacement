...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    static /* synthetic */ class C01438 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.DefaultSpecialEffectsController.C01438.<clinit>():void");
        }
    }
    ...
    public void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation next : list) {
            int i = C01438.f4x8b812b9a[next.getType().ordinal()];
            if (i == 1 || i == 2) {
                if (operation == null) {
                    operation = next;
                }
            ...
            animation2.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    container.post(new Runnable() {
                        public void run() {
                            C01373 r0 = C01373.this;
                            container.endViewTransition(view2);
                            C01373 r2 = C01373.this;
    ...
    public void applyContainerChanges(SpecialEffectsController.Operation operation) {
        ...
        int i = C01438.f4x8b812b9a[operation.getType().ordinal()];
        if (i == 1) {
