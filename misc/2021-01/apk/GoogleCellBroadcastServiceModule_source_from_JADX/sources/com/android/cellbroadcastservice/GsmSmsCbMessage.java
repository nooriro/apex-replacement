...
public class GsmSmsCbMessage {
    ...
    private static Pair<Integer, List<CbGeoUtils.Geometry>> parseWarningAreaCoordinates(byte[] bArr, int i) {
        ...
        IllegalArgumentException illegalArgumentException2 = new IllegalArgumentException("Invalid wac data, expected the length of pdu at least " + i4 + i3 + ", actual is " + bArr.length);
